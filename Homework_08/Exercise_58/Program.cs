...
int rowsOfFirstMatrix = GetNumber("Введите число строк первой матрицы: ");
int columnsOfFirstMatrix = GetNumber("Введите число столбцов первой матрицы: ");
int[,] firstMatrix = InitMatrix(rowsOfFirstMatrix, columnsOfFirstMatrix);

int rowsOfSecondMatrix = GetNumber("Введите число строк второй матрицы: ");
int columnsOfSecondMatrix = GetNumber("Введите число столбцов второй матрицы: ");
